...
from .models import SurveyAnswer, SurveyAnswerPhoto, SurveyQuestion, Client, SurveyQuestionChoice, Task
...
class PhotoReportForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.task and self.task.client:
            ...
            # Fallback: show client selection if no client assigned to task
